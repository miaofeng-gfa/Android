...
public final class CleanUtil {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(ApplicationUtil.getApp().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(ApplicationUtil.getApp().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(ApplicationUtil.getApp().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return ApplicationUtil.getApp().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return deleteFilesInDir(ApplicationUtil.getApp().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && deleteFilesInDir(ApplicationUtil.getApp().getExternalCacheDir());
    }
