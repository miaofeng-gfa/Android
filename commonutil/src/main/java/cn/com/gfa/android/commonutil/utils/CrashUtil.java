...
public final class CrashUtil {
    ...
    static {
        try {
            PackageInfo pi = ApplicationUtil.getApp().getPackageManager().getPackageInfo(ApplicationUtil.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && ApplicationUtil.getApp().getExternalCacheDir() != null)
            defaultDir = ApplicationUtil.getApp().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = ApplicationUtil.getApp().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
