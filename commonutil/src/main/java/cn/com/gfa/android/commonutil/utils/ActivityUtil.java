...
public final class ActivityUtil {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(ApplicationUtil.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(ApplicationUtil.getApp().getPackageManager()) == null ||
                ApplicationUtil.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static List<Activity> getActivityList() {
        return ApplicationUtil.sActivityList;
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(ApplicationUtil.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        if (ApplicationUtil.sTopActivityWeakRef != null) {
            Activity activity = ApplicationUtil.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = ApplicationUtil.sActivityList;
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? ApplicationUtil.getApp() : topActivity;
    }
