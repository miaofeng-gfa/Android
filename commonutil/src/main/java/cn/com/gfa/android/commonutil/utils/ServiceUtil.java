...
public final class ServiceUtil {
    ...
    public static Set getAllRunningService() {
        ActivityManager activityManager = (ActivityManager) ApplicationUtil.getApp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(ApplicationUtil.getApp(), cls);
        ApplicationUtil.getApp().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(ApplicationUtil.getApp(), cls);
        return ApplicationUtil.getApp().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls, final ServiceConnection conn, final int flags) {
        Intent intent = new Intent(ApplicationUtil.getApp(), cls);
        ApplicationUtil.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        ApplicationUtil.getApp().unbindService(conn);
    }
