...
public class NetworkUtil {
    ...
    public static void openWirelessSettings() {
        ApplicationUtil.getApp().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static NetworkInfo getNetworkInfo() {
        return ((ConnectivityManager) ApplicationUtil.getApp().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager wifiManager = (WifiManager) ApplicationUtil.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) ApplicationUtil.getApp()
