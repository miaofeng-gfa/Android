...
public final class ToastUtil {
    ...
    private static int yOffset    = (int) (64 * ApplicationUtil.getApp().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void show(@StringRes final int resId, final int duration) {
        show(ApplicationUtil.getApp().getResources().getText(resId).toString(), duration);
    }

    public static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(ApplicationUtil.getApp().getResources().getString(resId), args), duration);
    }
    ...
    public static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(ApplicationUtil.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(ApplicationUtil.getApp());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        ...
        LayoutInflater inflate = (LayoutInflater) ApplicationUtil.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
