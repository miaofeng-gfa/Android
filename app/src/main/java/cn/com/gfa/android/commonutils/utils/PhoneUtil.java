...
public final class PhoneUtil {
    ...
    public static boolean isPhone() {
        TelephonyManager tm = (TelephonyManager) ApplicationUtil.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) ApplicationUtil.getApp()
    ...
    public static void dial(final String phoneNumber) {
        ApplicationUtil.getApp().startActivity(IntentUtil.getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        ApplicationUtil.getApp().startActivity(IntentUtil.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        ApplicationUtil.getApp().startActivity(IntentUtil.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(ApplicationUtil.getApp(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = ApplicationUtil.getApp().getContentResolver();
